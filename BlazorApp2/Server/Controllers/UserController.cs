...
namespace BlazorApp2.Server.Controllers
{
    ...
    public class UserController
    {
        ...
        private readonly ProtectPasswordHelper _protect;
        public UserController(AppDbContext appDb, ProtectPasswordHelper protect)
        {
            _appDbContext = appDb;
            _protect = protect;
        }
        ...
        public async Task<bool> CreateUser([FromBody] User user)
        {
            if (!string.IsNullOrEmpty(user.Password))
            {
                ...
                Console.WriteLine("*passwordHash is " + user.Password);                
            }
